...
#================================= OS FLAGS =============================================
win32 {
  QMAKE_CXXFLAGS += -O2 -DWIN -DNDEBUG -m64 -Wa,-mbig-obj
  contains ( CONFIG, nogui ) {
    CONFIG += console
  }
  CONFIG -= app_bundle
...
macx {
  ...
  INCLUDEPATH += ../libQCustomPlot/ ../ccl-master/ ../CellEngine/include ../cellsignals/include ../CellPro/include ../Utility/include
...
win32 {
  CONFIG(debug, debug|release) {
        LIBS += -L../libQCustomPlot/build-debug/debug -lqcustomplot -L../ccl_Debug/debug -lccl -L../CellEngine/build/win/debug -lcellengine -L../cellsignals/build/win/debug -lsignals -L../CellPro/build/win/debug -lcellpro -L../Utility/build/win/debug -lutility
        PRE_TARGETDEPS += ../ccl_Debug/debug/libccl.a
  } else {
        LIBS += -L../libQCustomPlot/build-release/release -lqcustomplot -L../ccl_Release/release -lccl -L../CellEngine/build/win/release -lcellengine -L../cellsignals/build/win/release -lsignals -L../CellPro/build/win/release -lcellpro -L../Utility/build/win/release -lutility
        PRE_TARGETDEPS += ../ccl_Release/release/libccl.a
  }

  INCLUDEPATH += ../libQCustomPlot/src ../ccl-master/ ../CellEngine/include/ ../cellsignals/include/ ../CellPro/include ../Utility/include
